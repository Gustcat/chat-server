...
//go:generate minimock -i github.com/Gustcat/chat-server/internal/repository.ChatRepository -o chat_repository_minimock.go -n ChatRepositoryMock -p mocks
...
func (mmCreate *mChatRepositoryMockCreate) Expect(ctx context.Context, usernames []string) *mChatRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &ChatRepositoryMockCreateParams{ctx, usernames}
...
// ExpectUsernamesParam2 sets up expected param usernames for ChatRepository.Create
func (mmCreate *mChatRepositoryMockCreate) ExpectUsernamesParam2(usernames []string) *mChatRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatRepositoryMockCreate) Inspect(f func(ctx context.Context, usernames []string)) *mChatRepositoryMockCreate {
...
func (mmCreate *mChatRepositoryMockCreate) Set(f func(ctx context.Context, usernames []string) (i1 int64, err error)) *ChatRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatRepositoryMockCreate) When(ctx context.Context, usernames []string) *ChatRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &ChatRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &ChatRepositoryMockCreateParams{ctx, usernames},
...
func (mmCreate *ChatRepositoryMock) Create(ctx context.Context, usernames []string) (i1 int64, err error) {
	...
	mm_params := ChatRepositoryMockCreateParams{ctx, usernames}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ChatRepositoryMockCreateParams{ctx, usernames}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.usernames != nil && !minimock.Equal(*mm_want_ptrs.usernames, mm_got.usernames) {
				mmCreate.t.Errorf("ChatRepositoryMock.Create got unexpected parameter usernames, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to ChatRepositoryMock.Create. %v %v", ctx, usernames)
	return
}
